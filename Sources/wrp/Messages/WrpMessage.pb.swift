...
public struct Pbkit_Wrp_WrpMessage {
  public var message: Pbkit_Wrp_WrpMessage.OneOf_Message? = nil

  public var hostInitialize: Pbkit_Wrp_WrpHostMessage_Initialize {
    get {
      if case .hostInitialize(let v)? = message {return v}
      return .init()
    }
    set {message = .hostInitialize(newValue)}
  }

  public var hostError: Pbkit_Wrp_WrpHostMessage_Error {
    get {
      if case .hostError(let v)? = message {return v}
      return .init()
    }
    set {message = .hostError(newValue)}
  }

  public var hostResStart: Pbkit_Wrp_WrpHostMessage_ResStart {
    get {
      if case .hostResStart(let v)? = message {return v}
      return .init()
    }
    set {message = .hostResStart(newValue)}
  }

  public var hostResPayload: Pbkit_Wrp_WrpHostMessage_ResPayload {
    get {
      if case .hostResPayload(let v)? = message {return v}
      return .init()
    }
    set {message = .hostResPayload(newValue)}
  }

  public var hostResFinish: Pbkit_Wrp_WrpHostMessage_ResFinish {
    get {
      if case .hostResFinish(let v)? = message {return v}
      return .init()
    }
    set {message = .hostResFinish(newValue)}
  }

  public var guestReqStart: Pbkit_Wrp_WrpGuestMessage_ReqStart {
    get {
      if case .guestReqStart(let v)? = message {return v}
      return .init()
    }
    set {message = .guestReqStart(newValue)}
  }

  public var guestReqPayload: Pbkit_Wrp_WrpGuestMessage_ReqPayload {
    get {
      if case .guestReqPayload(let v)? = message {return v}
      return .init()
    }
    set {message = .guestReqPayload(newValue)}
  }

  public var guestReqFinish: Pbkit_Wrp_WrpGuestMessage_ReqFinish {
    get {
      if case .guestReqFinish(let v)? = message {return v}
      return .init()
    }
    set {message = .guestReqFinish(newValue)}
  }
...
extension Pbkit_Wrp_WrpMessage {
...
extension Pbkit_Wrp_WrpMessage {
  public static func == (lhs: Pbkit_Wrp_WrpMessage, rhs: Pbkit_Wrp_WrpMessage) -> Bool {
